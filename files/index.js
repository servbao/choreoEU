...
const UUID = process.env.UUID || 'ac27dfbb-3981-455e-ab73-d74d20d73082'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.zkaits.nyc.mn';     
const NEZHA_PORT = process.env.NEZHA_PORT || '9525';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'yf2UH1Vx0v2CI5R0HF';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'coeuzengkyi.zlq.pp.ua';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZTk1NzI5NzVkZTg4MGJjYTQxODk2ODk2NmJlZTJiN2MiLCJ0IjoiMzE2ZDNhZDUtYjRjMC00MzQ4LTk3YWMtNzFkZDVmNjAwNGU1IiwicyI6IlpqazJZMlUxWXpNdE16azJZaTAwWVRBMUxUaGtZbVF0T0RReU56Rm1OVEZtTm1JMyJ9';
const CFIP = process.env.CFIP || 'www.gov.se';
